...
def modifVar():
    tabVar()
    fonctions.texte_encadre("CHOIX DE LA VARIABLE")
    print(
        main.tab+"1.carte1",
        main.tab+"2.carte2",
        main.tab+"3.liCartes",
    ...
    while conti:
        ...
        if choix=="1":
            ...
            while sousConti:
                choix=input("Choix?:")
                if choix=="a":
                    print(fonctions.carte_to_chaine(choixVar("c")))
                    input("(Appuyer sur entrer pour revenir au menu)")
                    sousConti=False
                elif choix=="b":
                    fonctions.afficher_reussite(choixVar("lc"))
                    input("(Appuyer sur entrer pour revenir au menu)")
                    sousConti=False
                elif choix=="c":
                    fonctions.texte_encadre(choixVar("rc"))
                    input("(Appuyer sur entrer pour revenir au menu)")
                    sousConti=False
                elif choix=="r":
                    sousConti=False
