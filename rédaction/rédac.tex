...
\begin{figure}
\begin{center}
\includegraphics[scale=0.5]{img/bug_afficher_reussite_num.PNG}\caption{bug d'affichage relatif à la fonction "\textit{afficher$\_$reussite$\_$num}" telle qu'écrite au commit 728144c (cf.\ref{reussite})}
\end{center}
\end{figure}
...
\end{tikzpicture}%
\hspace*{\fill}
\subsection{afficher$\_$reussite$\_$num}\label{reussite}
\begin{lstlisting}
def afficher_reussite_num(liCartes):
    i=0
    li_saut=[]
